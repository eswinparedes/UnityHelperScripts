...
namespace SUHScripts
{
    ...
    [System.Serializable]
    public class PerlinNoisePulse : INoiseGenerator
    {
        ...
        public PerlinNoisePulse(float freq, float amp, float duration, AnimationCurve curve)
        {
            this.frequency = freq;
            this.amplitude = amp;
    ...
    [System.Serializable]
    public class PerlinNoiseConstant : INoiseGenerator
    {
        [SerializeField] float frequency;
        [SerializeField] float amplitude;

        public PerlinNoiseConstant(float freq, float amp)
        {
            frequency = freq;
            amplitude = amp;
        }
