...
namespace SUHScripts.Tests
{
    ...
    public class PerlinNoiseData_ConstantPopper
    {
        ...
        public INoiseGenerator Pop() =>
            new PerlinNoiseConstant(frequency, amplitude);
    }

    public class PerlinNoiseData_PulsePopper
    {
        [SerializeField] PerlinNoisePulse m_noise = default;

        public INoiseGenerator Pop() =>
            new PerlinNoisePulse(m_noise.Frequency, m_noise.Amplitude, m_noise.Duration, m_noise.BlendOverLifeTime);
    }
