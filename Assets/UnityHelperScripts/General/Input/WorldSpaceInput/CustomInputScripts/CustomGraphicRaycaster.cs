...
namespace SUHScripts
{
    ...
    public class CustomGraphicRaycaster : GraphicRaycaster, UnityEngine.EventSystems.IPointerEnterHandler
    {
        protected CustomGraphicRaycaster() { }

        [SerializeField]
        private Canvas m_EventCanvas = default;

        private Canvas canvas
        {
            get { return m_EventCanvas; }
        }

        [Tooltip("Event camera used by the raycaster, try LeftEyeCamera of cameraRig for OVR")]
        [SerializeField] Camera m_eventCamera = default;
        ...
        {
            CustomRayPointerEventData rayPointerEventData = eventData as CustomRayPointerEventData;
        ...
        {
            M_CustomInputModule inputModule = UnityEngine.EventSystems.EventSystem.current.currentInputModule as M_CustomInputModule;
        ...
        {
            UnityEngine.EventSystems.PointerEventData ped = e as CustomRayPointerEventData;
            if (ped != null)
            {
